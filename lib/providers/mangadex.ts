...
// MangaDex content ratings: safe | suggestive | erotica | pornographic (no 'mature')
// erotica/pornographic require auth — use safe+suggestive for unauthenticated calls
